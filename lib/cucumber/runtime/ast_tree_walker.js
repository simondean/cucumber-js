  ...
  var self = {
    ...
    visitScenario: function visitScenario(scenario, callback) {
      supportCodeLibrary.instantiateNewWorld(function(world) {
        ...
        self.createBeforeAndAfterStepsForAroundHooks();
        self.createBeforeStepsForBeforeHooks();
        self.createAfterStepsForAfterHooks();
        self.broadcastEventAroundUserFunction(
          event,
          function(callback) {
    ...
    createBeforeAndAfterStepsForAroundHooks: function createBeforeAndAfterStepsForAroundHooks() {
    ...
    createBeforeStepsForBeforeHooks: function createBeforeStepsForBeforeHooks() {
    ...
    createAfterStepsForAfterHooks: function createBeforeSteps() {
    ...
    visitBeforeSteps: function visitBeforeSteps(scenario, callback) {
      beforeSteps.forEach(function(beforeStep, callback) {
        beforeStep.getHook().setScenario(self.wrapScenario(scenario));
