  ...
  var self = {
    ...
    visitScenario: function visitScenario(scenario, callback) {
      supportCodeLibrary.instantiateNewWorld(function(world) {
        ...
        visitBeforeSteps();
        visitAfterSteps();
        // TODO: Visit the before and after steps
        // TODO: No longer hook up the scenario.  Call visitStep on the hooks instead
        var scenarioVisit = supportCodeLibrary.hookUpFunction(
          function(callback) {
    ...
    createAroundSteps: function createAroundSteps() {
      ...
      aroundHooks.syncForEach(function (aroundHook) {
        ...
        afterSteps.add(afterStep);
      });
    },

    createBeforeSteps: function createBeforeSteps() {
    ...
    createAfterSteps: function createBeforeSteps() {
